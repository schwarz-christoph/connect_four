...
@RunWith(Suite.class)
@Suite.SuiteClasses({FullConnectFourBoardTest.class, FullConnectFourGameTest.class, FullConnectFourPlayerTest.class, ConnectFourFieldTest.class, ConnectFourManagerTest.class})
