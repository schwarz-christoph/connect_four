...
public class ValidatingView implements View {
    ...
    private static boolean winningSequenceHorizontal(List<Field> fields) {
        ...
        return fields.stream()
                ...
                .filter(field -> containsField(fields, field.xCoordinate() + 1, field.yCoordinate(), field.owner()))
                .filter(field -> containsField(fields, field.xCoordinate() + 2, field.yCoordinate(), field.owner()))
                .anyMatch(field -> containsField(fields, field.xCoordinate() + maxAdderValue, field.yCoordinate(), field.owner()));
    }
    ...
    private static boolean winningSequenceVertical(List<Field> fields) {
        ...
        return fields.stream()
                ...
                .filter(field -> containsField(fields, field.xCoordinate(), field.yCoordinate() + 1, field.owner()))
                .filter(field -> containsField(fields, field.xCoordinate(), field.yCoordinate() + 2, field.owner()))
                .anyMatch(field -> containsField(fields, field.xCoordinate(), field.yCoordinate() + maxAdderValue, field.owner()));
    }
    ...
    private static boolean winningSequenceDiagonalDownward(List<Field> fields) {
        ...
        return fields.stream()
                ...
                .filter(field -> containsField(fields, field.xCoordinate() - 1, field.yCoordinate() - 1, field.owner()))
                .filter(field -> containsField(fields, field.xCoordinate() - 2, field.yCoordinate() - 2, field.owner()))
                .anyMatch(field -> containsField(fields, field.xCoordinate() - maxAdderValue, field.yCoordinate() - maxAdderValue, field.owner()));
    }
    ...
    private static boolean containsField(List<Field> fieldList, int xCoordinate, int yCoordinate, PlayerID owner) {
        return fieldList.stream()
                .anyMatch(field -> field.xCoordinate() == xCoordinate
                        && field.yCoordinate() == yCoordinate
                        && field.owner() == owner);
    }
}
